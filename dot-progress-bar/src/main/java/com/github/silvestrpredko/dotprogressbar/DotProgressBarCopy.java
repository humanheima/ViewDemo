 ...
 */
public class DotProgressBarCopy extends View {
    ...
    /**
     * 两个圆点水平之间的间距，从一个圆点的左边到另一个圆点的左边之间的距离
     */
     ...
     * {@link DotProgressBarCopy#RIGHT_DIRECTION} and {@link DotProgressBarCopy#LEFT_DIRECTION}
     */
    private int animationDirection;

    public DotProgressBarCopy(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initializeAttributes(attrs);
        init();
    }

    public DotProgressBarCopy(Context context, AttributeSet attrs) {
        super(context, attrs);
        initializeAttributes(attrs);
        init();
    }

    public DotProgressBarCopy(Context context) {
        super(context);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        horizontalSpace = dotRadius * 5;

        //(dotRadius * 2)直径
        //float circlesWidth = (dotAmount * (dotRadius * 2)) + horizontalSpace * (dotAmount - 1);
        //整个绘制区域的宽度
        float circlesWidth = (dotRadius * 2) + horizontalSpace * (dotAmount - 1);
        //整个绘制区域最左边的位置
