 ...
 */
class FullScreenSoftFitSystemWindowsActivity : BaseSoftKyeBoardAct() {


    companion object {

        fun launch(context: Context) {
            val starter = Intent(context, FullScreenSoftFitSystemWindowsActivity::class.java)
            context.startActivity(starter)
        }
    }

    override fun getLayoutResId(): Int {
        return R.layout.activity_fit_system_windows
    }
