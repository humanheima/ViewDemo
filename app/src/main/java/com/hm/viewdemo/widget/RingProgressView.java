...
public class RingProgressView extends View {
    ...
    public RingProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = (int) typedArray.getDimension(R.styleable.RingProgressView_rps_text_size, dip2px(20));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float radius = width / 2f - ringWidth / 2f;
        ...
        // 3. 画圆弧
        rectF.set(ringWidth / 2f, ringWidth / 2f, width - ringWidth / 2f, width - ringWidth / 2f);
        paint.setColor(ringProgressColor);
        canvas.drawArc(rectF, 0, currentProgress * 360f / maxProgress, false, paint);
