...
public class SlideDeleteLayout extends ViewGroup {
    ...
    public SlideDeleteLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.SlideDeleteLayoutDefStyleAttr);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SlideDeleteLayout, defStyleAttr, R.style.SlideDeleteLayoutDefStyleAttrRes);
        ...
        Log.e(TAG, "init: slideEnable=" + slideEnable);
        Log.e(TAG, "init: iosStyle=" + iosStyle);
        Log.e(TAG, "init: leftSlide=" + leftSlide);
        ta.recycle();
    }
