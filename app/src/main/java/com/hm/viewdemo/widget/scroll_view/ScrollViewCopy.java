...
public class ScrollViewCopy extends FrameLayout {
    ...
    public ScrollViewCopy(Context context) {
        this(context, null);
    }

    public ScrollViewCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollViewCopy(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public ScrollViewCopy(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
