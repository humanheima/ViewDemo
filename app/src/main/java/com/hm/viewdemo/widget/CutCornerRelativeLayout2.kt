 ...
 * Desc: 拷贝 CutCornerImageView 的逻辑，剪裁子View，注意，使用该View的时候必须设置一个背景。#00000000 也可以。
 */
class CutCornerRelativeLayout2(context: Context, attrs: AttributeSet?, defStyleAttr: Int) :
