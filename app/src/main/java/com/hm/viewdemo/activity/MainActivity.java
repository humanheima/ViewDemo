...
public class MainActivity extends BaseActivity {
    ...
    @OnClick({R.id.btn_about_scroller, R.id.btn_time_selector, R.id.btn_about_handler, R.id.btn_view_stub, R.id.btn_horizontal_vertical_conflict, R.id.btn_customer_view, R.id.btn_expandable_listview,
