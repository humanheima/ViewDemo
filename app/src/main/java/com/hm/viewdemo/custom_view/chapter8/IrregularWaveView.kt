 ...
 * Desc:
 */
class IrregularWaveView @JvmOverloads constructor(
        context: Context,
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        /**
         * 截取波纹图片上Rect(dx, 0, dx + bmpSrc.width, bmpSrc.height)的区域
         * 然后绘制在bmpSrc的Rect(0, 0, bmpSrc.width, bmpSrc.height)位置上
         */
        canvas.drawBitmap(bmpDst,
