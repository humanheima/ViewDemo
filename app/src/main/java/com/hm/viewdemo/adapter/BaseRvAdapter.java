 ...
 */
public abstract class BaseRvAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemTypeCallBack<T> {
    ...
    public abstract void bindViewHolder(BaseViewHolder holder, @NonNull T t, int position);
